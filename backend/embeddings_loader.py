...
#     pc.create_index(
#         name=index_name,
#         dimension=768,  # nomic-embed-text produces 768-dim embeddings
#         metric="cosine",
...
#     """Fetch embeddings using local Ollama 'nomic-embed-text' model"""
...
#     """Load all PDFs from folder, split text, embed, and push to Pinecone"""
...
#     load_and_embed_docs("backend/data/hr_policies/")
